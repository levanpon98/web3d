...
const HeroDetailsContainer = styled.div`
  ...
  &:before {
    ...
    background: radial-gradient(
        47% 80.69% at 101.41% 26.34%,
        #ad58db 0%,
        rgba(173, 88, 219, 0) 100%
      ),
      radial-gradient(
        63.59% 109.17% at 5.53% 69.05%,
        #2e248f 0%,
        rgba(46, 36, 143, 0) 100%
      ),
      linear-gradient(0deg, #5a4cdb, #5a4cdb), #211e4f;
  }
  &.background:before {
    opacity: 1;
  }
